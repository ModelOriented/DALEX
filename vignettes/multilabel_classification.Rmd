...
To use it, `y` parameter passed to `explain` function should have exactly the same format as the target vector used for the training process (ie. same number of levels and names of those levels).
